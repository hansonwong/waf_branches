#define NGX_CONFIGURE " --prefix=/usr/local/bluedon/bdwaf --with-pcre=/root/bluedon_waf/thirddep/pcre --add-module=/root/bluedon_waf/ModSecurity/nginx/modsecurity --with-debug --with-cc-opt='-I /home/ng_platform/bd_dpdk_warper/include -I /home/ng_platform/bd_dpdk_warper/include2' --with-dpdk='-L/home/ng_platform/bd_dpdk_warper/lib2 -ldpdk_bd -L/home/ng_platform/bd_dpdk_warper/lib -ldpdk -ldl -lrt'"
