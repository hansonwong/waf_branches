...
StringTokenizer::StringTokenizer(const std::string& _str, const std::string& _delim)
{
  ...
  */
   /* yzhou modified: size of "unsigned int" > size of "std::string::npos"
    *   the following deliminate loop will become infinite ! */
   /*unsigned int*/size_t curr_pos = 0;
...
std::string StringTokenizer::nextToken()
{
   ...
   std::string  tmp_str = "";
   /* yzhou modified: to follow return value of std::string::find() :
    *   size_t std::string::find(std::string&,size_t) */
   /*unsigned int*/size_t pos     = token_str.find(delim,0);
...
std::string StringTokenizer::nextToken(const std::string& delimiter)
{
   ...
   std::string  tmp_str = "";
   /* yzhou modified */
   /*unsigned int*/size_t pos     = token_str.find(delimiter,0);
...
std::string StringTokenizer::filterNextToken(const std::string& filterStr)
{
   ...
   /* yzhou modified */
   /*unsigned int*/size_t currentPos = 0;
