...
#define NDPI_PROTOCOL_IPP					227
#define NDPI_PROTOCOL_MDNS					8
#define NDPI_PROTOCOL_NTP					228
...
#define NDPI_PROTOCOL_YOUKU                             6   //227  replace IPP
#define NDPI_PROTOCOL_TONGHUASHUN                       9   //228  replace ntp
#define NDPI_PROTOCOL_QQGAME                            49  //229  replace move

/* UPDATE UPDATE UPDATE UPDATE UPDATE UPDATE UPDATE UPDATE UPDATE */
#define NDPI_LAST_IMPLEMENTED_PROTOCOL			NDPI_PROTOCOL_MOVE//NDPI_PROTOCOL_GIT
