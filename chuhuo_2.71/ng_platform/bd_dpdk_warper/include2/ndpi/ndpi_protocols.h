...
void ndpi_search_qqgame(struct ndpi_detection_module_struct *ndpi_struct, struct ndpi_flow_struct *flow);
...
//add by bluedon
void init_tonghuashun_dissector(struct ndpi_detection_module_struct *ndpi_struct, u_int32_t *id, NDPI_PROTOCOL_BITMASK *detection_bitmask);
...
void init_qqgame_dissector(struct ndpi_detection_module_struct *ndpi_struct, u_int32_t *id, NDPI_PROTOCOL_BITMASK *detection_bitmask);
