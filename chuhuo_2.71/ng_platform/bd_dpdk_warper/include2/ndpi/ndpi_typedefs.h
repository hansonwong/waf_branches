...
#define NDPI_IP_PORT_TIMES   4  // 2 ^ 3 == 8
#define NDPI_IP_PORT_BT_NUMS 8192
#define NDPI_IP_PORT_BT_GETS 8191
#define NDPI_IP_PORT_MAX_IPT (NDPI_IP_PORT_BT_NUMS << NDPI_IP_PORT_TIMES)
...
#define NDPI_IP_STRING_SIZE 40
  ...
  struct IP_PORT_st iportab[NDPI_IP_PORT_MAX_IPT];
  struct IP_PORT_qe iportqe[NDPI_IP_PORT_BT_NUMS];
...
struct ndpi_flow_struct {
  ...
  */
  ...
  u_int32_t pplive_stage4:4;
#endif
#ifdef NDPI_PROTOCOL_STARCRAFT
  u_int32_t starcraft_udp_stage : 3;	// 0-7
#endif
  u_int8_t  ppstream_request;
  u_int8_t  ppstream_response;
  /* internal structures to save functions calls */
  struct ndpi_packet_struct packet;
  struct ndpi_flow_struct *flow;
  struct ndpi_id_struct *src;
  struct ndpi_id_struct *dst;
  struct IP_PORT_st * iportsrc;
  struct IP_PORT_st * iportdst;
};
