...
extern struct IP_PORT_st * ndpi_lookup_ip_port(struct ndpi_detection_module_struct *ndpi_struct,
                                             u_int32_t ip,u_int16_t port,u_int8_t proto);
extern struct IP_PORT_st * ndpi_alloc_ip_port(struct ndpi_detection_module_struct *ndpi_struct,
	                                       u_int32_t ip,u_int16_t port,u_int8_t proto);
extern void ndpi_get_ip_port(struct ndpi_detection_module_struct *ndpi_struct,
	                             struct ndpi_flow_struct *flow);
