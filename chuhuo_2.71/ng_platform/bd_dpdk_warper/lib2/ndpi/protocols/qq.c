...
static const u_int16_t ndpi_valid_qq_versions[] = {
  ...
  0x1e0d, 0x3649, 0x3650, 0x3651, 0x3652, 0x3653, 0x3654, 0x3655, 0x3656,
  0x3657, 0x3658, 0x3659, 0x3660, 0x3661, 0x3662, 0x3663, 0x3664, 0x3665,
};
...
#endif
  if(command == 0x0000 || command > 0x00ff){
  	return 0;
  }
