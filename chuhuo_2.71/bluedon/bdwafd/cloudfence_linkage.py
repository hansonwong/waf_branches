...
class WAF_CLOUDFENCE():
    ...
    def logout(self, message='logout'):
        ResSimple = CFTP_pb2.ResSimple()
        ResSimple.result = 0
        ResSimple.description = message
        self.send_message(ResSimple, CFTP_pb2.MESS_LOGOUT)
...
if __name__ == "__main__":
    ...
    domains = ['www.peixu.com',"www.haoliang.com"]
    print waf_cloudfence.set_cloudfence_ddos(domains, 'username')
    print waf_cloudfence.get_cloudfence_ddos_status(domains, 'username')
    #print waf_cloudfence.logout()
