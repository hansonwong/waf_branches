...
from rulebase.sftp_down import sftp_down, sftp_get_filelist
...
def get_sftp_setting(file_type):
    ...
    # get sftp server setting from m_tbrolelib_autoupdate
    ...
    # return sftp servce ip, port and current version of file_type
...
def _get_update_conf(file_type):
    host_ip, port, current_ver = get_sftp_setting(file_type)
    ...
    new_files_on_server = sftp_get_filelist(host_ip, port)
