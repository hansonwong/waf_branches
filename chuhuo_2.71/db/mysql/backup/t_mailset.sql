...
CREATE TABLE `t_mailset` (
  `sender` varchar(45) DEFAULT NULL COMMENT 'sender''s mail',
  `username` varchar(45) DEFAULT NULL,
  `password` varchar(45) DEFAULT NULL,
  `smtpserver` varchar(45) DEFAULT NULL,
  `smtp_port` int(11) DEFAULT NULL,
  `receiver` varchar(45) DEFAULT NULL COMMENT 'receiver''s mail',
  `receiver_phone` varchar(45) DEFAULT NULL COMMENT 'receiver''s phone number',
...
INSERT INTO `t_mailset` VALUES ('mailfortestt@163.com','mailfortestt','111111','smtp.163.com',255,'liqian@chinabluedon.cn','18588813575',1);
...
-- Dump completed on 2018-04-23 16:51:11
