...
<html><head>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            if(data){
                ...
                jQuery.each(fields, function (i, field) { //jquery根据name属性查 找
                    if(field.name =='sIPV4'){
                        //$(":input[name='" + field.name + "']").val(data['sIPV4'].replace(',','\r\n'));
                        var str = data['sIPV4'];
                        var nStr= '';
                        strs=str.split(","); //字符分割
        ...
        //判断是否填了IP
        /*function setCheck(){
            var ipv4= $.trim($("#sIPV4").val());
            var ipv6= $.trim($("#sIPV6").val());
            if(ipv4!='' || ipv6!=''){
                $("#iByManagement,#iAllowPing,#iAllowTraceRoute").removeAttr("disabled");
            }else{
                $("#iByManagement,#iAllowPing,#iAllowTraceRoute").attr({disabled:"disabled"}).removeAttr("checked");
            }
        }*/
            ...
            <div class="sl-content" style=" width:392px; height:170px; overflow: hidden;">
                <div id="ipv4">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="date_add_table">
                        ...
                        <!--<tr>
                            <td align="right" colspan="3"><font color="gray" size="2"><p>格式：192.168.2.3/255.255.255.0或192.168.2.3/24。</p></font></td>

                        </tr>
                        <tr>
                            <td align="right" colspan="2"><font color="gray" size="2"><p>多个IP请分行填写</p></font></td>
                        </tr>-->
                        <!--<tr>
                            <td align="right">IP地址：</td>
                            <td><input class="validate[custom[ipv4]] text" name="sIPV4" id="sIPV4" onkeyup="setCheck()" /></td>
                        </tr>
                        <tr>
                            <td align="right">子网掩码：</td>
                            <td><input class="validate[custom[ipv4]] text" name="sIPV4Mask" /></td>
                        </tr>-->
                    </table>
                </div>
                ...
                <div id="ipv6" style="height: 155px;">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="date_add_table">
                        ...
                        <!--<tr>
                            <td align="right">IP地址：</td>
                            <td><input class="text" name="sIPV6" id="sIPV6" onkeyup="setCheck()" /></td>
                        </tr>
                        <tr>
                            <td align="right">子网掩码：</td>
                            <td><input class="text" name="sIPV6Mask" /></td>
                        </tr>-->
                    </table>
                </div>
            </div>
                    ...
                    <table  width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <!-- <td align="left" ><label style=" padding-left:6px;">
                                    <input name="iByManagement" id="iByManagement"  type="checkbox" value="1" />&nbsp;用于管理
                                </label> </td> -->
                            <td align="left" ><label style=" padding-left:6px;">
