...
<div class="openWin" style="padding:0px 10px;">
    <form action="" method="post" id="form_id" class="edit_form" >
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="date_add_table" style="border-left:1px solid #C4D0DC;border-right:1px solid #C4D0DC;">
            <tbody>
            <tr>
                <td class="t_r" width="15%"><span class="red">*</span> 名称</td>
                <td><input name="sName" class="validate[required,custom[name_rule]] text" /></td>
                <td class="t_r" ><input type="button" value="启用抓包" class="btn_ty "></td>
                <td><label><input type="checkbox" name="iStatus" value="1"/></label></td>
            </tr>
            <tr>
                <td class="t_r" width="15%"><span class="red">*</span> 运行时间</td>
                <td><input name="iRunTime"  class="validate[required,min[1],max[65535],custom[integer2]] text" style="width:60px;"/> 秒</td>
                <td class="t_r" ><input type="button" value="新建抓包" class="btn_ty btn_new"></td>
                <td>最多可新建32个抓包接口</td>
            </tr>
            </tbody>
        </table>
         <table id="pack" width="100%" border="0" cellpadding="0" cellspacing="0" class="date_add_table" >
            <tbody class="item">
                <tr>
                    <th class="t_r"><span class="red">*</span> 网络接口 <span class="org">1</span></th>
                    <td>
                    ...
                    <th><input type="button" value="删除" class="btn c_o" onclick="btn_del(this)" style="padding:3px 12px"><input type="hidden" name="pack_id[]" /><input type="hidden" name="sLan[]" /> </th>
                    <td></td>
                </tr>
                <tr>
                    <th class="t_r"><span class="red">*</span> CAP文件名称</th>
                    <td> <input type="text" name="sNameCap[]" class="validate[required,custom[name_rule]] text"/></td>
                    <th class="t_r">CAP文件容量</th>
                    <td> <input type="text" name="iCapacityCap[]" class="text validate[custom[integer2],min[1],max[30]]"/> M</td>     
                </tr>

                <tr>
                    <th class="t_r">源 IP/端口</th>
