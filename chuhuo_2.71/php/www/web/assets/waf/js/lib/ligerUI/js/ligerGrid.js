...
(function ($)
{
    ...
    $.ligerDefaults.Grid = {
        ...
        groupColumnDisplay: baseLanguage.common.groupColumnDisplay,             //分组 - 列显示名字
    ...
    $.ligerDefaults.GridString = {
        ...
        errorMessage: baseLanguage.base.errorMessage,
        //pageStatMessage: baseLanguage.base.pageFrom+'{from}'+baseLanguage.base.pageTo+'{to}'+baseLanguage.base.count+'{total}'+baseLanguage.base.item+'{pagesize}',
        pageStatMessage: baseLanguage.base.pageMessage,
        pageTextMessage: baseLanguage.base.pageTextMessage,
        loadingMessage: baseLanguage.base.loadingMessage,
        findTextMessage: baseLanguage.base.findTextMessage,
        noRecordMessage: baseLanguage.base.noRecordMessage,
        isContinueByDataChanged: baseLanguage.base.isContinueByDataChanged,
        cancelMessage: baseLanguage.base.cancelMessage,
        saveMessage: baseLanguage.base.saveMessage,
        applyMessage: baseLanguage.base.applyMessage,
        draggingMessage: '{count}'+baseLanguage.base.draggingMessage
    };
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            gridhtmlarr.push("                </div>");
            gridhtmlarr.push("                <div class='l-bar-separator'></div>");
            gridhtmlarr.push("                <div class='l-bar-group'><span class='pcontrol'> <input type='text' size='8' value='1' style='width:40px' /> / <span></span></span></div>");
            gridhtmlarr.push("                <div class='l-bar-separator'></div>");
            gridhtmlarr.push("                <div class='l-bar-group'>");
            ...
            if (p.autoFilter)
            {
                var item = {
                    // text: '高级查询',
                    text: baseLanguage.common.highCheckout,
                    gridid: g.id,
                    click: function ()
                    {
                        g.showFilter();
        ...
        showFilter: function ()
        {
            ...
            return g.winfilter = $.ligerDialog.open({
                ...
                buttons: [
                    ...
                    { text: baseLanguage.common.okVal, onclick: function (item, dialog) { loadData(); dialog.hide(); } },
					{ text: baseLanguage.common.cancelVal, onclick: function (item, dialog) { dialog.hide(); } }
                ]
            });
