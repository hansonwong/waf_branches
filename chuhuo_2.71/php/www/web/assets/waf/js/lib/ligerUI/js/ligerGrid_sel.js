...
(function ($)
{
    ...
    $.ligerDefaults.GridString = {
        ...
        errorMessage: baseLanguage.common.errorMessage,
        pageStatMessage: baseLanguage.common.pageFrom+'{from}'+baseLanguage.common.pageTo+'{to}'+baseLanguage.common.count+'{total}'+baseLanguage.common.item+'{pagesize}',
        pageTextMessage: baseLanguage.common.pageTextMessage,
        loadingMessage: baseLanguage.common.loadingMessage,
        findTextMessage: baseLanguage.common.findTextMessage,
        noRecordMessage: baseLanguage.common.noRecordMessage,
        isContinueByDataChanged: baseLanguage.common.isContinueByDataChanged,
        cancelMessage: baseLanguage.common.cancelMessage,
        saveMessage: baseLanguage.common.saveMessage,
        applyMessage: baseLanguage.common.applyMessage,
        draggingMessage: '{count}'+baseLanguage.common.draggingMessage
    };
