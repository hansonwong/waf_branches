 ...
 * http://ligerui.com
 *
 * Author daomi 2014 [ bluedon@bluedon ]
 *
 */
...
(function ($)
{
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
                ...
                $(g.columns).each(function (columnindex, column)
                {
                    ...
                    if (this.isrownumber)
                    {
                        ...
                        if (p.fixedCellHeight)
                            gridhtmlarr.push(' style = "height:auto;" ');
                        else
        ...
        // if(content==null) htmlarr.push('title="" ></div>');
        // if(content!==null) htmlarr.push(' title=' + content.replace(/<\/?[^>]*>/g,'') + '>' + content + '</div>');
        //          return htmlarr.join('');
        //      },
        _getCellHtml: function (rowdata, column)
        {
            ...
            //htmlarr.push('<div');
            htmlarr.push(' style = "width:' + parseInt(column._width - 8) + 'px;');
            if (p.fixedCellHeight) htmlarr.push('height:auto;');
            htmlarr.push('');
            if (column.align) htmlarr.push('text-align:' + column.align + ';');
            var content = g._getCellContent(rowdata, column);
