...
<div>
    <div class="index_box"  style="width:99.5%">
        <h3 class="m_title"><?=Yii::$app->sysLanguage->getTranslateBySymbol('websiteAccessAnalysis(month)')?></h3>
        <div class="chart_box">
...
<script>
    ...
    function setData(legend, data){
        ...
        var chartOption = {
            ...
            series : [
                {
                    name: '<?=Yii::$app->sysLanguage->getTranslateBySymbol('websiteAccessAnalysis(month)')?>',
                    type: 'pie',
                    radius : '55%',
                    center: ['50%', '60%'],
                    data: data,
