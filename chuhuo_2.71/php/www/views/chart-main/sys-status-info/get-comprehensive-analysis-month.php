...
<div>
    <div class="index_box"  style="width:99.5%">
        <h3 class="m_title"><?=Yii::$app->sysLanguage->getTranslateBySymbol('comprehensiveAnalysis(monthly)')?></h3>
        <div class="chart_box">
...
<script>
    ...
    function setData(data){
        ...
        var chartOption = {
            ...
            title: {
                show: false,
                text: '<?=Yii::$app->sysLanguage->getTranslateBySymbol('comprehensiveAnalysis(monthly)')?>'
            },
            tooltip: {
                trigger: 'axis'
            },
