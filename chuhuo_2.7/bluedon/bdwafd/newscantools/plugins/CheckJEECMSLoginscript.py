...
def run_domain(http,ob):
    ...
    try:
        ...
        logging.getLogger().error("File:chejeecmsloginscript.py, run_domain function :" + str(e) + ",task id:" + ob['task_id'] + ",domain id:" + ob['domain_id'])
        http.httlib2_set_follow_redirects(False)
        write_scan_log(ob['task_id'],ob['domain_id'],"File:chejeecmsloginscript.py, run_domain function :" + str(e))
    #end try
