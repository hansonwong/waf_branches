...
filename = "FrontPageCheckScript.py"
path_vul_file = sys_path("/vuls_db/vuldb_9")
#path_vul_file = "C:\\svn\\nvs_phase2\\scripts\\vuls_db_repo\\vuldb_9"
len_dic = {}
...
class check_page_thread(threading.Thread):
    ...
    def run(self):
        ...
        if checkErrorFileStatus(self.ob['scheme'],self.ob['domain'],self.ob['base_path'],"",self.req_method) == False:
            return
        #end if
        if checkErrorFileStatus(self.ob['scheme'],self.ob['domain'],self.ob['base_path'],"/",self.req_method) == False:
            return
        ...
        if checkErrorFileStatus(self.ob['scheme'],self.ob['domain'],self.ob['base_path'],".jsp",self.req_method) == False:
            return
        #end if
        if checkErrorFileStatus(self.ob['scheme'],self.ob['domain'],self.ob['base_path'],".asp",self.req_method) == False:
            return
        #end if
        if checkErrorFileStatus(self.ob['scheme'],self.ob['domain'],self.ob['base_path'],".aspx",self.req_method) == False:
            return
        #end if
        if checkErrorFileStatus(self.ob['scheme'],self.ob['domain'],self.ob['base_path'],".exe",self.req_method) == False:
            return
        #end if
        if checkErrorFileStatus(self.ob['scheme'],self.ob['domain'],self.ob['base_path'],".jsp",self.req_method) == False:
            return
        ...
        if checkErrorFileStatus(self.ob['scheme'],self.ob['domain'],self.ob['base_path'],".php",self.req_method) == False:
            return
        #end if
        if checkErrorFileStatus(self.ob['scheme'],self.ob['domain'],self.ob['base_path'],".htm",self.req_method) == False:
            return
        #end if
