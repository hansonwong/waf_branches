...
filename = "ZipCheckScript.py"
path_vul_file = sys_path("/vuls_db/vuldb_24")
len_dic = {}
...
class check_page_thread(threading.Thread):
    ...
    def run(self):
        ...
        if checkErrorFileStatus(self.ob['scheme'],self.ob['domain'],self.ob['base_path'],".zip",self.req_method) == False:
            return
        #end if
