...
path_vul_file = sys_path("/vuls_db/vuldb_19")
#path_vul_file = "C:\\svn\\nvs_phase2\\scripts\\vuls_db_repo\\vuldb_19"
len_dic = {}
...
class check_page_thread(threading.Thread):
    ...
    def check_if_support_head(self):
        ...
        fr.close()
        #print fr.code
        if fr.code == "200" or fr.code == "301" or fr.code == "302" :
            return True
        #end if
    ...
    def run(self):
        ...
        if checkErrorFileStatus(self.ob['scheme'],self.ob['domain'],self.ob['base_path'],".sql",self.req_method) == False:
            return
        #end if
        
        self.get_error_page_len()
        #print self.error_len_range
        ...
        if self.req_method == "HEAD":
            ...
            for v in self.vuls:
                ...
                try:        
                    ...
                    logging.getLogger().error("File:SqlFileCheckScript.py, check_page_thread::run function :" + str(e) + ",task id:" + self.ob['task_id'] + ", check_path: " + vs[3] + ",domain:" + str(self.domain))
                #end try
            #end for
...
def path_check_mgr(ob, domain, basedir, max_thread):
    ...
    try:
        ...
        #print e
        logging.getLogger().error("File:SqlFileCheckScript.py, path_check_mgr function :" + str(e) + ",task id:" + ob['task_id'] + ", domain:" + ob['domain'])
        return []
    #end try    
#end def
...
def run_domain(http,ob):
    ...
    try:     
        ...
        logging.getLogger().error("File:SqlFileCheckScript.py, run_domain function :" + str(e) + ",task id:" + ob['task_id'] + ", domain: " + ob['domain'])
        write_scan_log(ob['task_id'],ob['domain_id'],"File:SqlFileCheckScript.py, run_domain function :" + str(e))
        return []
    #end try    
#end def
...
if __name__ == '__main__':
    ...
    #www.vooioov.com
    #192.168.9.176
    path_check_mgr(1, "192.168.9.176:81", "/", 10)
    #print time.time() - t
