...
path_vul_file = sys_path("/vuls_db/vuldb_30_2")
...
def path_check_mgr(ob, domain, basedir, max_thread):
    ...
    try:
        ...
        #print e
        logging.getLogger().error("File:scanfckfilescirpt.py, path_check_mgr function :" + str(e) + ",task id:" + ob['task_id'] + ", domain:" + ob['domain'])
        return []
    #end try    
#end def
...
def run_domain(http,ob):
    ...
    try:     
        ...
        logging.getLogger().error("File:scanfckfilescirpt.py, run_domain function :" + str(e) + ",task id:" + ob['task_id'] + ", domain: " + ob['domain'])
        write_scan_log(ob['task_id'],ob['domain_id'],"File:scanfckfilescirpt.py, run_domain function :" + str(e))
        return []
    #end try    
#end def
