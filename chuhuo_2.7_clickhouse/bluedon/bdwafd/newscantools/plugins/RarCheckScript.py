...
filename = "RarCheckScript.py"
path_vul_file = sys_path("/vuls_db/vuldb_23")
#path_vul_file = "C:\\svn\\nvs_phase2\\scripts\\vuls_db_repo\\vuldb_23"
len_dic = {}
...
class check_page_thread(threading.Thread):
    ...
    def run(self):
        ...
        if checkErrorFileStatus(self.ob['scheme'],self.ob['domain'],self.ob['base_path'],".rar",self.req_method) == False:
            return
        #end if
...
def run_domain(http,ob):
    ...
    try:     
        ...
        llogging.getLogger().error("File:" + filename + ", run_domain function :" + str(e) + ",task id:" + ob['task_id'] + ", domain: " + ob['domain'])
