...
filename = "TxtCheckScript.py"
path_vul_file = "/var/vuls_db/vuldb_13"
#path_vul_file = "C:\\svn\\nvs_phase2\\scripts\\vuls_db_repo\\vuldb_13"
len_dic = {}
...
class check_page_thread(threading.Thread):
    ...
    def run(self):
        ...
        if checkErrorFileStatus(self.ob['scheme'],self.ob['domain'],self.ob['base_path'],".txt",self.req_method) == False:
            return
        #end if
