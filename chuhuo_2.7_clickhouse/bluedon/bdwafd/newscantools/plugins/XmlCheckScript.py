...
filename = "XmlCheckScript.py"
path_vul_file = "/var/vuls_db/vuldb_17"
#path_vul_file = "C:\\svn\\nvs_phase2\\scripts\\vuls_db_repo\\vuldb_17"
len_dic = {}
...
class check_page_thread(threading.Thread):
    ...
    def run(self):
        ...
        if checkErrorFileStatus(self.ob['scheme'],self.ob['domain'],self.ob['base_path'],".xml",self.req_method) == False:
            return
        #end if
