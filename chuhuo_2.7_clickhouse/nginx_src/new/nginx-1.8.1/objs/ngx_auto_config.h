#define NGX_CONFIGURE " --prefix=/usr/local/bdwaf --with-ld-opt=-L/root/new/lua-5.1.4/src/liblua.a --with-cust-ld-opt=-lhiredis --add-module=/root/new/modsecurity/nginx/modsecurity --add-module=/root/new/substi --with-http_ssl_module --conf-path=/usr/local/bdwaf/conf_proxy/nginx.conf --pid-path=/usr/local/bdwaf/logs_proxy/nginx.pid --http-log-path=/usr/local/bdwaf/logs_proxy/access.log --error-log-path=/usr/local/bdwaf/logs_proxy/error.log --lock-path=/usr/local/bdwaf/logs_proxy/nginx.lock"
...
#define NGX_CONF_PREFIX  "/usr/local/bdwaf/conf_proxy/"
#endif
...
#define NGX_CONF_PATH  "/usr/local/bdwaf/conf_proxy/nginx.conf"
#endif


#ifndef NGX_PID_PATH
#define NGX_PID_PATH  "/usr/local/bdwaf/logs_proxy/nginx.pid"
#endif


#ifndef NGX_LOCK_PATH
#define NGX_LOCK_PATH  "/usr/local/bdwaf/logs_proxy/nginx.lock"
#endif


#ifndef NGX_ERROR_LOG_PATH
#define NGX_ERROR_LOG_PATH  "/usr/local/bdwaf/logs_proxy/error.log"
#endif


#ifndef NGX_HTTP_LOG_PATH
#define NGX_HTTP_LOG_PATH  "/usr/local/bdwaf/logs_proxy/access.log"
#endif
